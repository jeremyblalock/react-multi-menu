...
import NonPassiveWheelElement from './NonPassiveWheel'
...
export class MultiMenu extends Component {
  ...
  setOverflow = () => {
    ...
    let {
      overflowBefore: prevOverflowBefore,
      overflowAfter: prevOverflowAfter,
    } = this.state
